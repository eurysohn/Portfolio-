...
const EmphasizedText = ({ className, ...props }: EmphasizedTextProps) => (
  <em
    className={cn(className, 'text-sm font-semibold text-secondary/70')}
    {...filterProps(props)}
  />
)
...
const ItalicText = ({ className, ...props }: ItalicTextProps) => (
  <i
    className={cn(className, 'italic text-secondary/70', PARAGRAPH_SIZES.body)}
    {...filterProps(props)}
  />
)
...
const BoldText = ({ className, ...props }: BoldTextProps) => (
  <b className={cn(className, 'text-lg font-semibold')} {...filterProps(props)} />
)
