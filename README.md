...
* **Python**
   * <i>Data Science </i>
     ...
     * [Optimise Routes & Cost](Python/Optimise Routes & Cost), using Linear Programming to create an optimised route for several supply and demand locations in lowest cost.
        * **Skills:** Python, NLP, Objective Detection, Node detection, Unsupervised learning, Image classification.
        * **Paper:** [Minimizing Shipping Cost and Redistribution for Recoffery](Python/Optimise Routes & Cost/orms.pdf)
